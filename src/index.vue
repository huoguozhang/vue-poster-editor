<template>
  <div class="poster-editor-comp" :id="editorUid">
    <div
      ...
      <div class="header-ct">
        ...
        <div class="right">
          ...
          <el-tooltip class="item m-l-16" effect="dark" content="编辑背景图" placement="top-start">
      ...
      <draggable
        ...
        :style="{
        background: editorBg && editorBg.bg ? editorBg.bg : '#fff',
    ...
    <!--<blankDialog v-model="showImageSelection" :contentHeight="500">
      <imageSelection v-model="editorBg"></imageSelection>
    </blankDialog>-->
  </div>
</template>
<script>
